...
generate-kubernetes-manifests:
	...
	helm template opentelemetry-demo open-telemetry/opentelemetry-demo --values newrelic/newrelic-helm-values.yaml --namespace otel-demo | sed '/helm.sh\/chart\:/d' | sed '/helm.sh\/hook/d' | sed '/managed-by\: Helm/d' >> kubernetes/opentelemetry-demo.yaml
